...
class EditReceitaActivity : AppCompatActivity() {
    ...
    private val biding by lazy { ActivityEditReceitaBinding.inflate(layoutInflater) }
    ...
    private fun loadValues() {
        biding.etValorReceita.setText(NumberFormat.getCurrencyInstance().format((receita.valor/100)))
        biding.txtDescription.setText(receita.decricao)
        biding.txtData.setText(receita.data)
        biding.switchReceita.isChecked = receita.Recebido
    }
